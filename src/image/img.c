...
const static struct img_type {
    ...
    {  9, 2, 84, 1, 2, 1, 0, _C(40), _R(300) }, /* 360k */
    { 10, 2, 30, 1, 2, 1, 0, _C(40), _R(300) }, /* 400k */
    { 15, 2, 84, 1, 2, 1, 0, _C(80), _R(360) }, /* 1.2MB */
    {  9, 1, 84, 1, 2, 1, 0, _C(80), _R(300) },
    { 10, 1, 30, 1, 2, 1, 0, _C(80), _R(300) },
    { 11, 1,  3, 2, 2, 1, 0, _C(80), _R(300) },
    {  8, 2, 84, 1, 2, 1, 0, _C(80), _R(300) },
    {  9, 2, 84, 1, 2, 1, 0, _C(80), _R(300) },
    { 10, 2, 30, 1, 2, 1, 0, _C(80), _R(300) },
    { 11, 2,  3, 2, 2, 1, 0, _C(80), _R(300) },
    { 18, 2, 84, 1, 2, 1, 0, _C(80), _R(300) },
    { 19, 2, 70, 1, 2, 1, 0, _C(80), _R(300) },
    { 21, 2, 18, 1, 2, 1, 0, _C(80), _R(300) },
    { 20, 2, 40, 1, 2, 1, 0, _C(80), _R(300) },
    { 36, 2, 84, 1, 2, 1, 0, _C(80), _R(300) },
    { 0 }
}, adfs_type[] = {
